...
def test_schedule(test_season, test_date):
    ...
    """
    column = ["LE_ID", "SR_ID", "SEASON_ID", "G_DT", "G_DT_TXT", "G_ID", "HEADER_NO", "G_TM", "S_NM", "AWAY_ID", "HOME_ID", "AWAY_NM", "HOME_NM", 
              "T_PIT_P_ID", "T_PIT_P_NM", "B_PIT_P_ID", "B_PIT_P_NM", "W_PIT_P_ID", "W_PIT_P_NM", "SV_PIT_P_ID", "SV_PIT_P_NM", "L_PIT_P_ID", "L_PIT_P_NM", 
              "T_D_PIT_P_ID", "T_D_PIT_P_NM", "B_D_PIT_P_ID", "B_D_PIT_P_NM", "GAME_STATE_SC", "CANCEL_SC_ID", "CANCEL_SC_NM", "GAME_INN_NO", "GAME_TB_SC", "GAME_TB_SC_NM", "GAME_RESULT_CK", 
